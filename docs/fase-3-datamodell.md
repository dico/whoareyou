...
| **Bruker** | `users` | Ja | Familiemedlem som logger inn og deler kontaktlisten innad i sin tenant. |
| **Kontakt** | `contacts` | Nei, aldri | Person man holder oversikt over. Har ingen innlogging. |
...
### users
Brukere som logger inn. Tilhører én tenant.
...
004_create_contact_photos.js
005_create_contact_field_types.js
006_create_contact_fields.js
007_create_labels.js
008_create_contact_labels.js
009_create_addresses.js
010_create_contact_addresses.js
011_create_relationship_types.js
012_create_relationships.js
013_create_posts.js
014_create_post_contacts.js
015_create_post_media.js
016_create_reminders.js
017_create_notifications.js
018_create_tasks.js
019_create_audit_log.js
020_seed_relationship_types.js
021_seed_contact_field_types.js
```
